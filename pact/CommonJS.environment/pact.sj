@STATIC;1.0;p;15;AppController.jt;8061;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;7994;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);{var the_class = objj_allocateClassPair(CPObject, "AppController"),
...
,["void","CPEvent"]), new objj_method(sel_getUid("addTouchListeners"), function $AppController__addTouchListeners(self, _cmd)
{
